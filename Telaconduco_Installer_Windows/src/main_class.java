...
public class main_class {
    public static void main(String args[]) {
        ...
        try {
            ...
            main.mkdir();
            File updates = new File(uhome + "/AppData/Telaconduco/updates");
            updates.mkdir();
            File clientfile = new File(uhome + "/AppData/Roaming/Telaconduco/Telaconduco_Client.jar");
            File updater = new File(uhome + "/AppData/Roaming/Telaconduco/Telaconduco_Updater.jar");
